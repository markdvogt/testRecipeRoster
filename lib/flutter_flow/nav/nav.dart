...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/fullCartView',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'fullCartView')
              : FullCartViewWidget(
        ...
        FFRoute(
          ...
          builder: (context, params) => const MainOrderHistoryWidget(),
        ),
        FFRoute(
          name: 'mainProfile',
          path: '/mainProfile',
        ...
        FFRoute(
          name: 'AddRecipe',
          path: '/addRecipe',
          builder: (context, params) => const AddRecipeWidget(),
        ),
        FFRoute(
          name: 'Walmart_WebView',
          path: '/walmartWebView',
          builder: (context, params) => const WalmartWebViewWidget(),
        ),
        FFRoute(
          name: 'test',
          path: '/test',
